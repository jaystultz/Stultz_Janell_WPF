...
console.log("There is not enough bread.  Today is not your day for a sandwich.") & alert("There is not enough bread.  Today is not your day for a sandwich."); //The printout and alert are found here for the "false" statement.
